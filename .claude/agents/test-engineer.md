...
5. Read `{target_project}/.build/phase-1-requirements/requirements.md` — 业务需求
6. Read `{target_project}/.build/phase-1-requirements/acceptance.yaml` — **机械化验收依据（auto_checks 必须全 PASS 才能交 Phase 8）**
7. Read `.claude/skills/build-agent-project/acceptance-yaml-schema.md` — runner 怎么跑
